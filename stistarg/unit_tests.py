...
class TestCheckbox(object):
    ...
    def test1(self):
        ...
        fits.writeto(filename, arr, clobber=True)
        stistarg_results = stistarg.stistarg(filename, source='point', checkboxsize=3)
        assert_almost_equals( stistarg_results[0], 16. - 1., places=5)
        assert_almost_equals( stistarg_results[1], 31. - 1., places=5)
        assert_almost_equals( stistarg_results[2], 877, places=5)
    ...
    def test2(self):
        ...
        fits.writeto(filename, arr, clobber=True)
        stistarg_results = stistarg.stistarg(filename, source='point', checkboxsize=3)
        assert_almost_equals( stistarg_results[0], 31 - 1., places=5)
        assert_almost_equals( stistarg_results[1], 16 - 1., places=5)
        assert_almost_equals( stistarg_results[2], 877, places=5)
    ...
    def test3(self):
        ...
        fits.writeto(filename, arr, clobber=True)
        stistarg_results = stistarg.stistarg(filename, source='point', checkboxsize=3)
        assert_almost_equals( stistarg_results[0], 31.002251 - 1., places=5)
        assert_almost_equals( stistarg_results[1], 16.002251 - 1., places=5)
        assert_almost_equals( stistarg_results[2], 889, places=5)
    ...
    def test4(self):
        ...
        fits.writeto(filename, arr, clobber=True)
        stistarg_results = stistarg.stistarg(filename, source='point', checkboxsize=3)
        assert_almost_equals( stistarg_results[0], 40.998863 - 1., places=5)
        assert_almost_equals( stistarg_results[1], 25.998861 - 1., places=5)
        assert_almost_equals( stistarg_results[2], 1757, places=5)
    ...
    def test5(self):
        ...
        assert_almost_equals( stistarg_results[0], 16 - 1., places=5)
        assert_almost_equals( stistarg_results[1], 31 - 1., places=5)
        assert_almost_equals( stistarg_results[2], 11861, places=5)
    ...
    def test7(self):
        ...
        fits.writeto(filename, arr, clobber=True)
        stistarg_results = stistarg.stistarg(filename, source='diffuse', checkboxsize=25)
        assert_almost_equals( stistarg_results[0], 36 - 1., places=5)
        assert_almost_equals( stistarg_results[1], 21 - 1., places=5)
        assert_almost_equals( stistarg_results[2], 22158, places=5)
    ...
    def test8(self):
        ...
        fits.writeto(filename, arr, clobber=True)
        stistarg_results = stistarg.stistarg(filename, source='diffuse', checkboxsize=25)
        assert_almost_equals( stistarg_results[0], 37.835854 - 1., places=5)
        assert_almost_equals( stistarg_results[1], 22.835852 - 1., places=5)
        assert_almost_equals( stistarg_results[2], 32824, places=5)
    ...
    def test12(self):
        ...
        fits.writeto(filename, arr, clobber=True)
        stistarg_results = stistarg.stistarg(filename, source='point', checkboxsize=3)
        assert_almost_equals( stistarg_results[0], 61.000000 - 1., places=5)
        assert_almost_equals( stistarg_results[1], 81.002426 - 1., places=5)
        assert_almost_equals( stistarg_results[2], 2474, places=5)
    ...
    def test13(self):
        ...
        stistarg_results = stistarg.stistarg(filename, source='point', checkboxsize=3)
        assert_almost_equals( stistarg_results[0], 61.000000 - 1., places=5)
        assert_almost_equals( stistarg_results[1], 81.001793 - 1., places=5)
        assert_almost_equals( stistarg_results[2], 3342, places=5)
    ...
    def test14(self):
        ...
        assert_almost_equals( stistarg_results[0], 60.986961 - 1., places=5)
        assert_almost_equals( stistarg_results[1], 75.986252 - 1., places=5)
        assert_almost_equals( stistarg_results[2], 51776, places=5)
    ...
    def test_original(self):
        ...
        fits.writeto(filename, arr, clobber=True)
        stistarg_results = stistarg.stistarg(filename, source='diffuse', checkboxsize=25)
        assert_almost_equals( stistarg_results[0], 37.835854 - 1., places=5)  # Results from Solaris binary
        assert_almost_equals( stistarg_results[1], 22.835852 - 1., places=5)  # Results from Solaris binary
